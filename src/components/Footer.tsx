            ...
            <div className="max-w-3xl mx-auto px-8 space-y-8">
                ...
                <div className="pt-8 border-t border-[#1F1F22] flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
                    <div className="text-right">
                        ...
                        <span className="font-bold">أحمد سليمان محمد العادلي</span>
                    </div>
                ...
                <div className="pt-16 text-xs text-[#888888]">
                    <p>© {new Date().getFullYear()} كافة حقوق النشر محفوظة للدراسة الأكاديمية.</p>
                </div>
            </div>
        </footer>
    );
